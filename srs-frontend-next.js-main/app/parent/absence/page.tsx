  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newAbsence: Absence = {
        id: `abs-${Date.now()}`,
        student: "Emma Johnson", // In a real app, this would come from the selected student
        date: date,
        type: absenceType,
        reason: reason,
        status: "pending",
                      ...
                      <Popover>
                        ...
                        <PopoverContent className="w-auto p-0" align="start">
                          <CalendarComponent
                            ...
                            initialFocus
                            disabled={[
                              { before: new Date(new Date().setDate(new Date().getDate() - 14)) }, // Can't select dates more than 14 days in the past
                              { after: new Date(new Date().setDate(new Date().getDate() + 7)) }    // Can't select dates more than 7 days in the future
                            ]}
                          />
                        </PopoverContent>
                      </Popover>
                              ...
                              <div className="flex justify-between items-start mb-2">
                                <div>
                                  <div className="flex items-center gap-2 mb-1">
                                    <h3 className="text-lg font-semibold">{absence.student}</h3>
